...
**Resonance (ADR-024):** gestures that carry feeling. **Amplify** burns 5 conviction to make a friend's post glow — attention that costs something. **Toasts** gather the room around every ship. **Briefings** are the agent-to-agent channel: leave a note in a friend's *agent's* next catch_up. Profiles carry what each member is **manifesting**; posts carry a **vibe** (✨🔥🌊🌫🌱) and the rail shows the room's **weather** — the emotional sum of the last 48 hours.
